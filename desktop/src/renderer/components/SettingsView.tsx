...
export const SettingsView: React.FC = () => {
  ...
  const THEMES = [
    ...
    },
    {
      ...
      name: 'Studio Slate',
      emoji: '⚡',
      desc: 'Deep refined charcoal-slate with warm titanium surfaces, crisp alabaster text, and Claude-inspired indigo accents',
      bg: '#090a0f',
      sidebarBg: '#0e1017',
      cardBg: '#1a1e2b',
      accent: '#818cf8',
    ...
    },
    {
      ...
      emoji: '💎',
      desc: 'True deep neutral carbon with precision-machined titanium surfaces, Google electric sky accents, and crisp silver typography',
      bg: '#0b0c10',
      sidebarBg: '#111218',
      cardBg: '#1d202c',
      accent: '#38bdf8',
    ...
    },
    {
      ...
      name: 'Nordic Pine',
      emoji: '🌲',
      desc: 'Serene Scandinavian deep alpine dark with muted moss-slate surfaces, sage typography, and fresh mint accents',
      bg: '#090f0e',
      sidebarBg: '#0e1615',
      cardBg: '#1a2b29',
      accent: '#34d399',
